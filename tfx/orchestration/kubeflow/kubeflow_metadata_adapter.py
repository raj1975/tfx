...
class KubeflowMetadataAdapter(metadata.Metadata):
  ...
  def _is_eligible_previous_execution(
    ...
    current_execution.properties['kfp_pod_name'].string_value = ''
    target_execution.properties['kfp_pod_name'].string_value = ''
  ...
  def _prepare_execution(
    ...
    exec_properties['kfp_pod_name'] = metadata_store_pb2.STRING
    ...
    if os.environ[_KFP_POD_NAME_KEY]:
      ...
      execution.properties['kfp_pod_name'].string_value = kfp_pod_name
    return execution
